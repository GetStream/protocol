...
type JoinRequest struct {
	...
	JoinMode models.JoinMode `protobuf:"varint,5,opt,name=join_mode,json=joinMode,proto3,enum=stream.video.sfu.models.JoinMode" json:"join_mode,omitempty"`
}
...
func (x *JoinRequest) GetJoinMode() models.JoinMode {
	if x != nil {
		return x.JoinMode
	}
	return models.JoinMode(0)
}
...
var file_video_sfu_event_events_proto_rawDesc = []byte{
	...
	0x61, 0x72, 0x74, 0x69, 0x63, 0x69, 0x70, 0x61, 0x6e, 0x74, 0x22, 0xf8, 0x01, 0x0a, 0x0b, 0x4a,
	...
	0x74, 0x61, 0x69, 0x6c, 0x73, 0x12, 0x3e, 0x0a, 0x09, 0x6a, 0x6f, 0x69, 0x6e, 0x5f, 0x6d, 0x6f,
	0x64, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x21, 0x2e, 0x73, 0x74, 0x72, 0x65, 0x61,
	0x6d, 0x2e, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x2e, 0x73, 0x66, 0x75, 0x2e, 0x6d, 0x6f, 0x64, 0x65,
	0x6c, 0x73, 0x2e, 0x4a, 0x6f, 0x69, 0x6e, 0x4d, 0x6f, 0x64, 0x65, 0x52, 0x08, 0x6a, 0x6f, 0x69,
	0x6e, 0x4d, 0x6f, 0x64, 0x65, 0x22, 0x51, 0x0a, 0x0c, 0x4a, 0x6f, 0x69, 0x6e, 0x52, 0x65, 0x73,
...
var file_video_sfu_event_events_proto_goTypes = []interface{}{
	...
	(models.JoinMode)(0),             // 35: stream.video.sfu.models.JoinMode
	(*models.CallState)(nil),         // 36: stream.video.sfu.models.CallState
	(models.ConnectionQuality)(0),    // 37: stream.video.sfu.models.ConnectionQuality
	(*models.Codec)(nil),             // 38: stream.video.sfu.models.Codec
	(*models.CallGrants)(nil),        // 39: stream.video.sfu.models.CallGrants
}
var file_video_sfu_event_events_proto_depIdxs = []int32{
	...
	35, // 26: stream.video.sfu.event.JoinRequest.join_mode:type_name -> stream.video.sfu.models.JoinMode
	36, // 27: stream.video.sfu.event.JoinResponse.call_state:type_name -> stream.video.sfu.models.CallState
	32, // 28: stream.video.sfu.event.ParticipantJoined.participant:type_name -> stream.video.sfu.models.Participant
	32, // 29: stream.video.sfu.event.ParticipantLeft.participant:type_name -> stream.video.sfu.models.Participant
	16, // 30: stream.video.sfu.event.ConnectionQualityChanged.connection_quality_updates:type_name -> stream.video.sfu.event.ConnectionQualityInfo
	37, // 31: stream.video.sfu.event.ConnectionQualityInfo.connection_quality:type_name -> stream.video.sfu.models.ConnectionQuality
	18, // 32: stream.video.sfu.event.AudioLevelChanged.audio_levels:type_name -> stream.video.sfu.event.AudioLevel
	20, // 33: stream.video.sfu.event.AudioSender.media_request:type_name -> stream.video.sfu.event.AudioMediaRequest
	38, // 34: stream.video.sfu.event.AudioSender.codec:type_name -> stream.video.sfu.models.Codec
	0,  // 35: stream.video.sfu.event.VideoLayerSetting.priority:type_name -> stream.video.sfu.event.VideoLayerSetting.Priority
	38, // 36: stream.video.sfu.event.VideoLayerSetting.codec:type_name -> stream.video.sfu.models.Codec
	22, // 37: stream.video.sfu.event.VideoSender.media_request:type_name -> stream.video.sfu.event.VideoMediaRequest
	38, // 38: stream.video.sfu.event.VideoSender.codec:type_name -> stream.video.sfu.models.Codec
	23, // 39: stream.video.sfu.event.VideoSender.layers:type_name -> stream.video.sfu.event.VideoLayerSetting
	21, // 40: stream.video.sfu.event.ChangePublishQuality.audio_senders:type_name -> stream.video.sfu.event.AudioSender
	24, // 41: stream.video.sfu.event.ChangePublishQuality.video_senders:type_name -> stream.video.sfu.event.VideoSender
	39, // 42: stream.video.sfu.event.CallGrantsUpdated.current_grants:type_name -> stream.video.sfu.models.CallGrants
