...
type JoinResponse struct {
	...
	PublishCodec                 *models.Codec     `protobuf:"bytes,4,opt,name=publish_codec,json=publishCodec,proto3" json:"publish_codec,omitempty"`
}
...
func (x *JoinResponse) GetPublishCodec() *models.Codec {
	if x != nil {
		return x.PublishCodec
	}
	return nil
}
...
var file_video_sfu_event_events_proto_rawDesc = []byte{
	...
	0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0xff, 0x01, 0x0a, 0x0c, 0x4a, 0x6f,
	...
	0x65, 0x63, 0x6f, 0x6e, 0x64, 0x73, 0x12, 0x43, 0x0a, 0x0d, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x73,
	0x68, 0x5f, 0x63, 0x6f, 0x64, 0x65, 0x63, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e,
	0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x2e, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x2e, 0x73, 0x66, 0x75,
	0x2e, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x73, 0x2e, 0x43, 0x6f, 0x64, 0x65, 0x63, 0x52, 0x0c, 0x70,
	0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x43, 0x6f, 0x64, 0x65, 0x63, 0x22, 0x76, 0x0a, 0x11, 0x50,
	...
	0x43, 0x0a, 0x0b, 0x41, 0x75, 0x64, 0x69, 0x6f, 0x53, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x12, 0x34,
	...
	0x6f, 0x64, 0x65, 0x63, 0x22, 0x9f, 0x02, 0x0a, 0x11, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x4c, 0x61,
	...
	0x74, 0x79, 0x4d, 0x6f, 0x64, 0x65, 0x22, 0x86, 0x01, 0x0a, 0x0b, 0x56, 0x69, 0x64, 0x65, 0x6f,
...
var file_video_sfu_event_events_proto_depIdxs = []int32{
	...
	47, // 45: stream.video.sfu.event.JoinResponse.publish_codec:type_name -> stream.video.sfu.models.Codec
	41, // 46: stream.video.sfu.event.ParticipantJoined.participant:type_name -> stream.video.sfu.models.Participant
	41, // 47: stream.video.sfu.event.ParticipantLeft.participant:type_name -> stream.video.sfu.models.Participant
	41, // 48: stream.video.sfu.event.ParticipantUpdated.participant:type_name -> stream.video.sfu.models.Participant
	23, // 49: stream.video.sfu.event.ConnectionQualityChanged.connection_quality_updates:type_name -> stream.video.sfu.event.ConnectionQualityInfo
	48, // 50: stream.video.sfu.event.ConnectionQualityInfo.connection_quality:type_name -> stream.video.sfu.models.ConnectionQuality
	25, // 51: stream.video.sfu.event.AudioLevelChanged.audio_levels:type_name -> stream.video.sfu.event.AudioLevel
	47, // 52: stream.video.sfu.event.AudioSender.codec:type_name -> stream.video.sfu.models.Codec
	47, // 53: stream.video.sfu.event.VideoLayerSetting.codec:type_name -> stream.video.sfu.models.Codec
	47, // 54: stream.video.sfu.event.VideoSender.codec:type_name -> stream.video.sfu.models.Codec
	28, // 55: stream.video.sfu.event.VideoSender.layers:type_name -> stream.video.sfu.event.VideoLayerSetting
	27, // 56: stream.video.sfu.event.ChangePublishQuality.audio_senders:type_name -> stream.video.sfu.event.AudioSender
	29, // 57: stream.video.sfu.event.ChangePublishQuality.video_senders:type_name -> stream.video.sfu.event.VideoSender
	49, // 58: stream.video.sfu.event.CallGrantsUpdated.current_grants:type_name -> stream.video.sfu.models.CallGrants
	50, // 59: stream.video.sfu.event.GoAway.reason:type_name -> stream.video.sfu.models.GoAwayReason
	51, // 60: stream.video.sfu.event.CallEnded.reason:type_name -> stream.video.sfu.models.CallEndedReason
