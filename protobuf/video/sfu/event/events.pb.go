...
type JoinRequest struct {
	...
	// is_migrating is set when the participant is migrating from another SFU
	// and will execute the migrate protocol.
	IsMigrating bool `protobuf:"varint,5,opt,name=is_migrating,json=isMigrating,proto3" json:"is_migrating,omitempty"`
}
...
func (x *JoinRequest) GetIsMigrating() bool {
	if x != nil {
...
var file_video_sfu_event_events_proto_rawDesc = []byte{
	...
	0x61, 0x72, 0x74, 0x69, 0x63, 0x69, 0x70, 0x61, 0x6e, 0x74, 0x22, 0xdb, 0x01, 0x0a, 0x0b, 0x4a,
	...
	0x74, 0x61, 0x69, 0x6c, 0x73, 0x12, 0x21, 0x0a, 0x0c, 0x69, 0x73, 0x5f, 0x6d, 0x69, 0x67, 0x72,
	0x61, 0x74, 0x69, 0x6e, 0x67, 0x18, 0x05, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x69, 0x73, 0x4d,
	0x69, 0x67, 0x72, 0x61, 0x74, 0x69, 0x6e, 0x67, 0x22, 0x51, 0x0a, 0x0c, 0x4a, 0x6f, 0x69, 0x6e,
	...
	0x52, 0x09, 0x63, 0x61, 0x6c, 0x6c, 0x53, 0x74, 0x61, 0x74, 0x65, 0x22, 0x76, 0x0a, 0x11, 0x50,
	...
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x42, 0x5d, 0x42, 0x0b, 0x53, 0x66, 0x75, 0x45, 0x76, 0x65,
