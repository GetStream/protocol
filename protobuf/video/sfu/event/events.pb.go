...
var file_video_sfu_event_events_proto_rawDesc = []byte{
	...
	0x0b, 0x70, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69, 0x70, 0x61, 0x6e, 0x74, 0x22, 0x97, 0x01, 0x0a,
...
var file_video_sfu_event_events_proto_goTypes = []interface{}{
	...
	(*models.Participant)(nil),       // 25: stream.video.sfu.models.Participant
	(models.TrackUnpublishReason)(0), // 26: stream.video.sfu.models.TrackUnpublishReason
	(*models.ClientDetails)(nil),     // 27: stream.video.sfu.models.ClientDetails
...
var file_video_sfu_event_events_proto_depIdxs = []int32{
	...
	25, // 19: stream.video.sfu.event.TrackPublished.participant:type_name -> stream.video.sfu.models.Participant
	24, // 20: stream.video.sfu.event.TrackUnpublished.type:type_name -> stream.video.sfu.models.TrackType
	26, // 21: stream.video.sfu.event.TrackUnpublished.cause:type_name -> stream.video.sfu.models.TrackUnpublishReason
	25, // 22: stream.video.sfu.event.TrackUnpublished.participant:type_name -> stream.video.sfu.models.Participant
	27, // 23: stream.video.sfu.event.JoinRequest.client_details:type_name -> stream.video.sfu.models.ClientDetails
	28, // 24: stream.video.sfu.event.JoinResponse.call_state:type_name -> stream.video.sfu.models.CallState
	25, // 25: stream.video.sfu.event.ParticipantJoined.participant:type_name -> stream.video.sfu.models.Participant
	25, // 26: stream.video.sfu.event.ParticipantLeft.participant:type_name -> stream.video.sfu.models.Participant
	14, // 27: stream.video.sfu.event.ConnectionQualityChanged.connection_quality_updates:type_name -> stream.video.sfu.event.ConnectionQualityInfo
	29, // 28: stream.video.sfu.event.ConnectionQualityInfo.connection_quality:type_name -> stream.video.sfu.models.ConnectionQuality
	16, // 29: stream.video.sfu.event.AudioLevelChanged.audio_levels:type_name -> stream.video.sfu.event.AudioLevel
	30, // 30: stream.video.sfu.event.VideoSender.codec:type_name -> stream.video.sfu.models.Codec
	18, // 31: stream.video.sfu.event.VideoSender.layers:type_name -> stream.video.sfu.event.VideoLayerSetting
	19, // 32: stream.video.sfu.event.ChangePublishQuality.video_senders:type_name -> stream.video.sfu.event.VideoSender
	31, // 33: stream.video.sfu.event.CallGrantsUpdated.current_grants:type_name -> stream.video.sfu.models.CallGrants
