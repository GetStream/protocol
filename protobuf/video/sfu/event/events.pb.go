...
var file_video_sfu_event_events_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x22, 0x80, 0x01, 0x0a, 0x0e, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x50, 0x75, 0x62, 0x6c,
	...
	0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0xc7, 0x01, 0x0a, 0x10, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x55,
	...
	0x73, 0x68, 0x52, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x52, 0x05, 0x63, 0x61, 0x75, 0x73, 0x65, 0x22,
	0x97, 0x01, 0x0a, 0x0b, 0x4a, 0x6f, 0x69, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	...
	0x6f, 0x6e, 0x49, 0x64, 0x12, 0x4d, 0x0a, 0x0e, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x5f, 0x64,
	...
	0x69, 0x6c, 0x73, 0x4a, 0x04, 0x08, 0x03, 0x10, 0x04, 0x22, 0x7e, 0x0a, 0x0c, 0x4a, 0x6f, 0x69,
	...
	0x65, 0x52, 0x09, 0x63, 0x61, 0x6c, 0x6c, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x2b, 0x0a, 0x11,
	0x70, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69, 0x70, 0x61, 0x6e, 0x74, 0x5f, 0x63, 0x6f, 0x75, 0x6e,
	0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x10, 0x70, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69,
	0x70, 0x61, 0x6e, 0x74, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x76, 0x0a, 0x11, 0x50, 0x61, 0x72,
	...
	0x76, 0x65, 0x6c, 0x73, 0x22, 0x57, 0x0a, 0x11, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x4c, 0x61, 0x79,
	...
	0x63, 0x74, 0x69, 0x76, 0x65, 0x4a, 0x04, 0x08, 0x03, 0x10, 0x04, 0x4a, 0x04, 0x08, 0x04, 0x10,
	0x05, 0x4a, 0x04, 0x08, 0x05, 0x10, 0x06, 0x4a, 0x04, 0x08, 0x06, 0x10, 0x07, 0x22, 0x8c, 0x01,
	...
	0x6c, 0x61, 0x79, 0x65, 0x72, 0x73, 0x4a, 0x04, 0x08, 0x01, 0x10, 0x02, 0x22, 0x66, 0x0a, 0x14,
	0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x51, 0x75, 0x61,
	0x6c, 0x69, 0x74, 0x79, 0x12, 0x48, 0x0a, 0x0d, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x5f, 0x73, 0x65,
	...
	0x52, 0x0c, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x53, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x73, 0x4a, 0x04,
	0x08, 0x01, 0x10, 0x02, 0x22, 0x79, 0x0a, 0x11, 0x43, 0x61, 0x6c, 0x6c, 0x47, 0x72, 0x61, 0x6e,
...
var file_video_sfu_event_events_proto_goTypes = []interface{}{
	...
	(*ConnectionQualityInfo)(nil),    // 15: stream.video.sfu.event.ConnectionQualityInfo
	...
	(*VideoLayerSetting)(nil),        // 19: stream.video.sfu.event.VideoLayerSetting
	(*VideoSender)(nil),              // 20: stream.video.sfu.event.VideoSender
	(*ChangePublishQuality)(nil),     // 21: stream.video.sfu.event.ChangePublishQuality
	(*CallGrantsUpdated)(nil),        // 22: stream.video.sfu.event.CallGrantsUpdated
	(*models.ICETrickle)(nil),        // 23: stream.video.sfu.models.ICETrickle
	...
	(*models.CallGrants)(nil),        // 33: stream.video.sfu.models.CallGrants
}
var file_video_sfu_event_events_proto_depIdxs = []int32{
	...
	23, // 4: stream.video.sfu.event.SfuEvent.ice_trickle:type_name -> stream.video.sfu.models.ICETrickle
	21, // 5: stream.video.sfu.event.SfuEvent.change_publish_quality:type_name -> stream.video.sfu.event.ChangePublishQuality
	...
	22, // 14: stream.video.sfu.event.SfuEvent.call_grants_updated:type_name -> stream.video.sfu.event.CallGrantsUpdated
	24, // 15: stream.video.sfu.event.Error.error:type_name -> stream.video.sfu.models.Error
	25, // 16: stream.video.sfu.event.ICETrickle.peer_type:type_name -> stream.video.sfu.models.PeerType
	8,  // 17: stream.video.sfu.event.SfuRequest.join_request:type_name -> stream.video.sfu.event.JoinRequest
	4,  // 18: stream.video.sfu.event.SfuRequest.health_check_request:type_name -> stream.video.sfu.event.HealthCheckRequest
	26, // 19: stream.video.sfu.event.TrackPublished.type:type_name -> stream.video.sfu.models.TrackType
	26, // 20: stream.video.sfu.event.TrackUnpublished.type:type_name -> stream.video.sfu.models.TrackType
	27, // 21: stream.video.sfu.event.TrackUnpublished.cause:type_name -> stream.video.sfu.models.TrackUnpublishReason
	28, // 22: stream.video.sfu.event.JoinRequest.client_details:type_name -> stream.video.sfu.models.ClientDetails
	29, // 23: stream.video.sfu.event.JoinResponse.call_state:type_name -> stream.video.sfu.models.CallState
	30, // 24: stream.video.sfu.event.ParticipantJoined.participant:type_name -> stream.video.sfu.models.Participant
	30, // 25: stream.video.sfu.event.ParticipantLeft.participant:type_name -> stream.video.sfu.models.Participant
	15, // 26: stream.video.sfu.event.ConnectionQualityChanged.connection_quality_updates:type_name -> stream.video.sfu.event.ConnectionQualityInfo
	31, // 27: stream.video.sfu.event.ConnectionQualityInfo.connection_quality:type_name -> stream.video.sfu.models.ConnectionQuality
	17, // 28: stream.video.sfu.event.AudioLevelChanged.audio_levels:type_name -> stream.video.sfu.event.AudioLevel
	32, // 29: stream.video.sfu.event.VideoSender.codec:type_name -> stream.video.sfu.models.Codec
	19, // 30: stream.video.sfu.event.VideoSender.layers:type_name -> stream.video.sfu.event.VideoLayerSetting
	20, // 31: stream.video.sfu.event.ChangePublishQuality.video_senders:type_name -> stream.video.sfu.event.VideoSender
	33, // 32: stream.video.sfu.event.CallGrantsUpdated.current_grants:type_name -> stream.video.sfu.models.CallGrants
