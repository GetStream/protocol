...
type EncodeStats struct {
	...
	TrackType            TrackType `protobuf:"varint,1,opt,name=track_type,json=trackType,proto3,enum=stream.video.sfu.models.TrackType" json:"track_type,omitempty"`
	Codec                *Codec    `protobuf:"bytes,2,opt,name=codec,proto3" json:"codec,omitempty"`
	AvgFrameEncodeTimeMs int64     `protobuf:"varint,3,opt,name=avg_frame_encode_time_ms,json=avgFrameEncodeTimeMs,proto3" json:"avg_frame_encode_time_ms,omitempty"`
...
func (x *EncodeStats) GetAvgFrameEncodeTimeMs() int64 {
	if x != nil {
...
func (x *DecodeStats) GetAvgFrameDecodeTimeMs() int64 {
	if x != nil {
...
func (x *DecodeStats) GetAvgFps() int64 {
	if x != nil {
		return x.AvgFps
	}
	return 0
...
var file_video_sfu_models_models_proto_rawDesc = []byte{
	...
	0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x14, 0x61, 0x76, 0x67, 0x46, 0x72, 0x61, 0x6d,
	...
	0x03, 0x52, 0x14, 0x61, 0x76, 0x67, 0x46, 0x72, 0x61, 0x6d, 0x65, 0x44, 0x65, 0x63, 0x6f, 0x64,
	0x65, 0x54, 0x69, 0x6d, 0x65, 0x4d, 0x73, 0x12, 0x17, 0x0a, 0x07, 0x61, 0x76, 0x67, 0x5f, 0x66,
	0x70, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x61, 0x76, 0x67, 0x46, 0x70, 0x73,
	0x12, 0x50, 0x0a, 0x0f, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x5f, 0x64, 0x69, 0x6d, 0x65, 0x6e, 0x73,
