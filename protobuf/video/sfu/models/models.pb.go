...
type Codec struct {
	...
	PayloadType        uint32 `protobuf:"varint,13,opt,name=payload_type,json=payloadType,proto3" json:"payload_type,omitempty"`
	Name               string `protobuf:"bytes,10,opt,name=name,proto3" json:"name,omitempty"`
...
var file_video_sfu_models_models_proto_rawDesc = []byte{
	...
	0x18, 0x0d, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x54,
