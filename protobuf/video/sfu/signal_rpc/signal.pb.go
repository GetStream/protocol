...
type ICERestartRequest struct {
	...
	PeerType  models.PeerType `protobuf:"varint,3,opt,name=peer_type,json=peerType,proto3,enum=stream.video.sfu.models.PeerType" json:"peer_type,omitempty"`
}
...
func (x *ICERestartRequest) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
var file_video_sfu_signal_rpc_signal_proto_rawDesc = []byte{
	...
	0x6f, 0x64, 0x65, 0x6c, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8b, 0x01, 0x0a, 0x11,
	...
	0x72, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x21, 0x2e, 0x73,
	...
	0x2e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x32, 0xa5, 0x05,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x62, 0x42, 0x0b, 0x53, 0x66, 0x75, 0x53, 0x69, 0x67, 0x6e,
