...
<img src={require('../assets/layout_single-participant.png').default} style={{ width: '50%' }} />
...
<img src={require('../assets/layout_grid.png').default} style={{ width: '50%' }} />

### Spotlight

This layout shows a video in a spotlight and the rest of the participants in a separate list or grid.

<img src={require('../assets/layout_spotlight.png').default} style={{ width: '50%' }} />
...
<img src={require('../assets/layout_custom_options.png').default} style={{ width: '50%' }} />
