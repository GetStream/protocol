...
It enables users to stream content using an RTMP client, such as OBS (Open Broadcaster Software), and have that content delivered to participants in a Stream WebRTC session. 
